...
function length_bt = SaveFinalState_v3PLATO(filenames, save_file, time_offset)
...
SH_breaklat = ncread("./ERA5_NH_SH_break_lat_v2.nc", ...
    "SH_break_lat");
SH_breaklat = medfilt1(SH_breaklat, 13);
CPT_height = ncread("./CPT_height_temp_all_v2.nc", ...
    "CPT_height");
CPT_lat = ncread("./CPT_height_temp_all_v2.nc", ...
    "lat");
pheight_380K = ncread("./height_380K.nc", "height_380K");
SH_breaklat_lon = ncread("./ERA5_NH_SH_break_lat_v2.nc", ...
    "lon");
SH_breaklat_time = caldays(ncread("./ERA5_NH_SH_break_lat_v2.nc", ...
...
% tropopause
[below_the_tropopause_edited, bad_trajectory, ~] = ...
    SH_FixWobblesV6(below_the_tropopause, smooth_trop, smooth_z, num_days);
...
%
[in_the_tropics_edited, bt] = SH_FixWobblesTropBreakV2(in_the_tropics, ...
...
% earlier
for i = 1:length(lat)
    if ismember(i, bt) || ismember(i, bad_trajectory)
