...
% SaveTrajectories(filenamesWK1, 1, datetime(2016,12,28,21,0,0));
% SaveTrajectories(filenamesWK2, '2_v2', datetime(2017,1,25,23,59,0));
% SaveTrajectories(filenamesWK3, '3_v2', datetime(2017,2,22,23,59,0));
% SaveTrajectories(filenamesWK4, 4, datetime(2017,3,22,21,0,0));
% SaveTrajectories(filenamesWK5, 5, datetime(2017,4,19,21,0,0));
% SaveTrajectories(filenamesWK6, 6, datetime(2017,5,17,21,0,0));
% SaveTrajectories(filenamesWK7, 7, datetime(2017,6,14,21,0,0));
% SaveTrajectories(filenamesWK8, 8, datetime(2017,7,12,21,0,0));
SaveTrajectories(filenamesWK9, 9, datetime(2017,8,9,21,0,0));
% SaveTrajectories(filenamesWK10, 10, datetime(2017,9,6,21,0,0));
% SaveTrajectories(filenamesWK11, 11, datetime(2017,10,04,21,0,0));
% SaveTrajectories(filenamesWK12, 12, datetime(2017,11,01,21,0,0));
% SaveTrajectories(filenamesWK13, 13, datetime(2017,11,29,21,0,0));
% SaveTrajectories(filenamesWK14, '14_v2', datetime(2017,12,27,21,0,0));
% SaveTrajectories(filenamesWK15, '15_v2', datetime(2018,1,24,21,0,0));